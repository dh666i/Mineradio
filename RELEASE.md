...
- 当前源码基线和稳定安装版为 `1.5.2`；README、SECURITY 与 Release 资产必须保持一致。
...
- `dist/Mineradio-1.5.2-Setup.exe`
- `dist/Mineradio-1.5.2-Setup.exe.blockmap`
- `dist/latest.yml`
- `dist/Mineradio-1.5.2-SHA256SUMS.txt`
