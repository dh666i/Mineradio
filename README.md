...
当前稳定安装版为 `v1.5.0`。Windows 安装包仅通过本仓库 Releases 发布。

`v1.5.0` 补齐网易云发现与类型搜索、完整歌单操作、音频增强、大型队列和桌面安全边界，并修复设置与音乐库排版。完整变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.5.0) 下载带 `1.5.0` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
