...
当前稳定安装版为 `v1.5.1`。Windows 安装包仅通过本仓库 Releases 发布。

`v1.5.1` 完善沉浸全屏、启动恢复和搜索页布局，统一保留完整播放器控制栏，并优化窗口控件间距。完整变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.5.1) 下载带 `1.5.1` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
