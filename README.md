...
当前稳定安装版为 `v1.3.2`。Windows 安装包仅通过本仓库 Releases 发布。

`v1.3.2` 改进应用内更新下载：自动测试候选线路、优先使用更快线路，并支持持续低速时自动或手动切换。完整变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.3.2) 下载带 `1.3.2` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
