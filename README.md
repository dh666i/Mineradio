...
当前稳定安装版为 `v1.3.0`。Windows 安装包仅通过本仓库 Releases 发布。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.3.0) 下载带 `1.3.0` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
