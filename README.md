...
当前稳定安装版为 `v1.5.2`。Windows 安装包仅通过本仓库 Releases 发布。

`v1.5.2` 修复多显示器拖动与窗口位置恢复，并优化音乐库播放队列和歌单详情布局。完整变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.5.2) 下载带 `1.5.2` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
