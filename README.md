...
当前稳定安装版为 `v1.3.1`。Windows 安装包仅通过本仓库 Releases 发布。

本次补丁调整顶部更新入口：仅在检测到 GitHub 最新版本高于本机版本时显示；同版本、检查中或检查失败时保持隐藏。完整变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
Windows 用户可从 [GitHub Releases](https://github.com/dh666i/Mineradio/releases/tag/v1.3.1) 下载带 `1.3.1` 版本号的安装包，并使用同一 Release 中的 SHA256 文件核对摘要。
