...
- 重排 Home 信息架构：每日推荐不再纵向跨满页面，曲目预览紧跟主操作；“接着听”改为跨栏紧凑横卡，减少大面积空白与卡片拉伸。
- 清理仓库展示层中的历史支持、收款和宣传内容，仅在 NOTICE 中保留许可证要求的最低限度版权来源声明。
- 将 Home 施工区升级为网易云每日推荐：首页展示日期、封面与前四首预览，并提供完整推荐列表。
